        ...
        <div className="dash-container" style={{ alignItems: 'center', justifyContent: 'center' }}>
            <div style={{
                ...
                <div style={{ marginBottom: 32, textAlign: 'center' }}>
                    <div className="dash-brand" style={{ justifyContent: 'center', marginBottom: 16 }}>
                        <Activity size={32} className="accent" />
                        <span style={{ fontSize: 32 }}>NARRATIVE<span className="accent">.</span>FLOW</span>
                    </div>
